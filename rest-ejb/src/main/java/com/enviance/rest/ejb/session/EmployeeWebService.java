...
/**
 * This is class is a stateless session bean or EJB 
 * that exposes a method as a RESTful web service endpoint
 *
...
public class EmployeeWebService {
	@EJB
	private EmployeeSessionBean _employeeBean;
	...
	public Response getEmployees(@QueryParam("number") 
		...
		try {
			...
			// Set employee DTO collection from QueryDTO
			employeeDTOCol = _employeeBean.getEmployees(queryDTO);
